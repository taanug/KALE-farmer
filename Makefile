...
bindings-mainnet:
	stellar contract bindings typescript --contract-id CDL74RF5BLYR2YBLCCI7F5FB6TPSCLKEJUBSD2RSVWZ4YHF3VMFAIGWA --network vc --output-dir ./bun_scripts/kale-sc-sdk__raw --overwrite